...
public class Helper extends UnicastRemoteObject implements HelperService {
    ...
    public Helper() throws RemoteException, AccessException{
    	bindHelperTOReg();
        ipOfCurrentHelper = "10.10.10.104";
...
//        }
    ...
    public TreeMap<Integer, Integer> sortChunks(List<Integer> list, TreeMap<Integer, Integer> tree) throws RemoteException{
    	...
    	System.out.println("Sort method: Incoming list size is: "+ list.size()+" tmap "+tree.size());
